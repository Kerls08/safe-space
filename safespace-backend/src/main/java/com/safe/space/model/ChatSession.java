...
public class ChatSession {
    ...
    /**
     * Authenticated username of the student who owns this session.
     * Used for session discovery (so the student can find sessions
     * initiated on their behalf by professionals from crisis alerts).
     * NEVER exposed in chat messages — only used for lookup.
     */
    @Column(length = 50)
